  ...
  return input(
    {
      ...
      input_row("Finches"     , species_status::endemic            , 0.0,
        {
          3.0282,1.3227,0.8223,0.4286,0.3462,0.245,0.0808,
          0.0527,0.0327,0.0221,0.118,0.0756,0.0525,0.0322,0.0118
        } ),
      input_row("Mimus"       , species_status::endemic            , 0.0,
        { 3.958,3.422,2.884,0.459 } ),
