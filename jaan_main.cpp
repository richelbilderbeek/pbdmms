...
int main()
{
    Parameters p(1000,     /// Max generations
                 ...
                 0.05       /// Rate of migration between the two habitats
                 );
    std::vector<Habitat> habitat_list;
    habitat_list.reserve(2);
    {
        Habitat habitat0(0,     /// optimum preference
                         0,     /// optimum trait
                         40,    /// stabilising selection on choosiness
                         16,    /// stabilising selection on ornament
                         2.0,   /// Efficiency of conversion from quality to signal
                         0.8    /// Selection on viability
                         );
        Habitat habitat1(0,     /// optimum preference
                         0,     /// optimum trait
                         40,    /// stabilising selection on choosiness
                         16,    /// stabilising selection on ornament
                         4.0,   /// Efficiency of conversion from quality to signal
                         0.8    /// Selection on viability
                         );
    ...
    simulation.run(generator, p, habitat_list, "22_H0Eff2_H1Eff4.csv", "jaan_hist.csv");
    return 0;
}
/*{ Based on Chapter 8
