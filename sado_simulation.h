...
double calc_comp(const population &pop, const double xi,
                 const parameters &p) noexcept;

///@param as: attractivenesses
offspring create_kids(const population &pop, const indiv &mother,
                      const std::vector<double> &as, const parameters &p);
...
population create_next_generation_overlapping(population pop,
                                              const parameters &p);

/// Create the next generation, allow for seperate generations
population create_next_generation_seperate(const population &pop,
                                           const parameters &p);

/// May return zero kids
offspring try_to_create_kids(const population &pop, const int index,
                             const parameters &p);
...
std::vector<double> get_attractivenesses(const population &pop, const double pi,
                                         const double xi, const parameters &p);
