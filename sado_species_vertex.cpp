...
sado::sp_vert_desc sado::add_species_vertex(const sado::species& s, sado::species_graph& g) noexcept
{
...
std::vector<sado::species> sado::get_species_vertexes(const sado::species_graph& g) noexcept
{
